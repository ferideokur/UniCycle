...
<button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-all flex items-center justify-between ${
                      ...
                      isExpanded || isMainActive ? "bg-blue-50 text-blue-700" : "text-slate-600 hover:bg-slate-50 hover:text-blue-600"
...
<button
                              ...
                              className={`w-full text-left px-3 py-2 rounded-lg text-sm font-semibold transition-all ${
                                ...
                                isSubActive ? "bg-blue-600 text-white shadow-sm" : "text-slate-500 hover:bg-blue-50 hover:text-blue-700"
...
<p className="text-lg font-medium opacity-90 mb-6 leading-relaxed">
                  ...
                  Üst dönemlerin ders notlarını, çıkmış sorularını ve kitaplarını hemen keşfet. Hazır notlar seni bekliyor.
</p>
...
<div className="absolute right-0 -bottom-10 opacity-20 md:opacity-40 text-[150px] md:text-[220px] leading-none transform -rotate-12">📚</div>
</div>
...
<p className="text-slate-500 font-medium text-lg mb-8 max-w-md mx-auto">
                ...
                Sanki kampüste kimse bu kategoride bir şey satmıyor. İlk adımı sen atmaya ne dersin?
</p>
...
<span className="text-xs font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-md shrink-0">@{p.user && p.user.fullName ? p.user.fullName.split(" ")[0] : "Öğrenci"}</span>
</div>
